...
skylake/multiply_accumulate_skylake-O2.o:     file format elf64-x86-64
...
0000000000000000 <multiply_accumulate(double const*, double const*, unsigned long)>:
  ...
  45:	c5 fb 10 54 c7 08    	vmovsd xmm2,QWORD PTR [rdi+rax*8+0x8]
  4b:	c4 e2 f1 b9 04 c6    	vfmadd231sd xmm0,xmm1,QWORD PTR [rsi+rax*8]
